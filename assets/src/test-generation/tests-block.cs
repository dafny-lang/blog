// Dafny program tests-block.dfy compiled into C#
...
// Command-line arguments: test tests-block.dfy
// tests-block.dfy
...
namespace UsersbhaveshbhatiablogblogassetssrctestgenerationchessdfyUnitTests {
  ...
  public partial class __default {
    public static void Test0()
    {
      ...
      _2_chessPos0 = Chess.Pos.create(new BigInteger(2), BigInteger.One);
      if (!(((((_2_chessPos0).dtor_row).Sign != -1) && (((_2_chessPos0).dtor_row) < (new BigInteger(8)))) && ((((_2_chessPos0).dtor_col).Sign != -1) && (((_2_chessPos0).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(8,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      ...
      _6_chessPos1 = Chess.Pos.create(new BigInteger(2), new BigInteger(5));
      if (!(((((_6_chessPos1).dtor_row).Sign != -1) && (((_6_chessPos1).dtor_row) < (new BigInteger(8)))) && ((((_6_chessPos1).dtor_col).Sign != -1) && (((_6_chessPos1).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(13,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      ...
      _10_chessPos2 = Chess.Pos.create(BigInteger.Zero, new BigInteger(6));
      if (!(((((_10_chessPos2).dtor_row).Sign != -1) && (((_10_chessPos2).dtor_row) < (new BigInteger(8)))) && ((((_10_chessPos2).dtor_col).Sign != -1) && (((_10_chessPos2).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(18,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      ...
      if (!(((((_14_chessPos3).dtor_row).Sign != -1) && (((_14_chessPos3).dtor_row) < (new BigInteger(8)))) && ((((_14_chessPos3).dtor_col).Sign != -1) && (((_14_chessPos3).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(23,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      ...
      if (!(((((_18_chessPos4).dtor_row).Sign != -1) && (((_18_chessPos4).dtor_row) < (new BigInteger(8)))) && ((((_18_chessPos4).dtor_col).Sign != -1) && (((_18_chessPos4).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(28,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      ...
      if (!(Chess.__default.BoardIsValid(_21_validBoard0))) {
        throw new Dafny.HaltException("tests-block.dfy(32,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
    ...
    public static void Test1()
    {
      ...
      _1_kind0 = Chess.Kind.create_King(_0_color0);
      Chess._IPos _2_chessPos0;
      _2_chessPos0 = Chess.Pos.create(BigInteger.Zero, new BigInteger(7));
      if (!(((((_2_chessPos0).dtor_row).Sign != -1) && (((_2_chessPos0).dtor_row) < (new BigInteger(8)))) && ((((_2_chessPos0).dtor_col).Sign != -1) && (((_2_chessPos0).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(39,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess._IPiece _3_piece0;
      _3_piece0 = Chess.Piece.create(_1_kind0, _2_chessPos0);
      Chess._IColor _4_color1;
      _4_color1 = Chess.Color.create_Black();
      ...
      _5_kind1 = Chess.Kind.create_Knight(_4_color1);
      Chess._IPos _6_chessPos1;
      _6_chessPos1 = Chess.Pos.create(BigInteger.One, new BigInteger(5));
      if (!(((((_6_chessPos1).dtor_row).Sign != -1) && (((_6_chessPos1).dtor_row) < (new BigInteger(8)))) && ((((_6_chessPos1).dtor_col).Sign != -1) && (((_6_chessPos1).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(44,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess._IPiece _7_piece1;
      _7_piece1 = Chess.Piece.create(_5_kind1, _6_chessPos1);
      Chess._IColor _8_color2;
      _8_color2 = Chess.Color.create_Black();
      ...
      _9_kind2 = Chess.Kind.create_Knight(_8_color2);
      Chess._IPos _10_chessPos2;
      _10_chessPos2 = Chess.Pos.create(BigInteger.One, new BigInteger(4));
      if (!(((((_10_chessPos2).dtor_row).Sign != -1) && (((_10_chessPos2).dtor_row) < (new BigInteger(8)))) && ((((_10_chessPos2).dtor_col).Sign != -1) && (((_10_chessPos2).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(49,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess._IPiece _11_piece2;
      _11_piece2 = Chess.Piece.create(_9_kind2, _10_chessPos2);
      Chess._IColor _12_color3;
      _12_color3 = Chess.Color.create_Black();
      ...
      _13_kind3 = Chess.Kind.create_Pawn(_12_color3);
      Chess._IPos _14_chessPos3;
      _14_chessPos3 = Chess.Pos.create(BigInteger.Zero, new BigInteger(5));
      if (!(((((_14_chessPos3).dtor_row).Sign != -1) && (((_14_chessPos3).dtor_row) < (new BigInteger(8)))) && ((((_14_chessPos3).dtor_col).Sign != -1) && (((_14_chessPos3).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(54,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess._IPiece _15_piece3;
      _15_piece3 = Chess.Piece.create(_13_kind3, _14_chessPos3);
      Chess._IColor _16_color4;
      _16_color4 = Chess.Color.create_Black();
      ...
      _17_kind4 = Chess.Kind.create_Pawn(_16_color4);
      Chess._IPos _18_chessPos4;
      _18_chessPos4 = Chess.Pos.create(BigInteger.Zero, new BigInteger(6));
      if (!(((((_18_chessPos4).dtor_row).Sign != -1) && (((_18_chessPos4).dtor_row) < (new BigInteger(8)))) && ((((_18_chessPos4).dtor_col).Sign != -1) && (((_18_chessPos4).dtor_col) < (new BigInteger(8)))))) {
        throw new Dafny.HaltException("tests-block.dfy(59,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess._IPiece _19_piece4;
      _19_piece4 = Chess.Piece.create(_17_kind4, _18_chessPos4);
      Dafny.ISequence<Chess._IPiece> _20_piece5;
      _20_piece5 = Dafny.Sequence<Chess._IPiece>.FromElements(_3_piece0, _7_piece1, _11_piece2, _15_piece3, _19_piece4);
      ...
      _21_validBoard0 = _20_piece5;
      if (!(Chess.__default.BoardIsValid(_21_validBoard0))) {
        throw new Dafny.HaltException("tests-block.dfy(63,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("If this check fails at runtime, the test does not meet the type constraints").ToVerbatimString(false));}
      Chess.__default.Describe(_21_validBoard0);
    }
  }
...
")).ToVerbatimString(false));
      ...
      if (!(_0_success)) {
        throw new Dafny.HaltException("tests-block.dfy(1,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test failures occurred: see above.
").ToVerbatimString(false));}
    }
  }
