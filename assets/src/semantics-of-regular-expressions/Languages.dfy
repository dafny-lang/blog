module Languages {
  ...
  lemma BisimilarityIsTransitiveAlternativeTwo<A(!new)>(k: nat, L1: Lang, L2: Lang, L3: Lang)
    ensures Bisimilar#[k](L1, L2) && Bisimilar#[k](L2, L3) ==> Bisimilar#[k](L1, L3)
  {
    if k != 0 {
      if Bisimilar#[k](L1, L2) && Bisimilar#[k](L2, L3) {
        forall a ensures Bisimilar#[k - 1](L1.delta(a), L2.delta(a)) && Bisimilar#[k-1](L2.delta(a), L3.delta(a)) {
          BisimilarityIsTransitiveAlternativeTwo(k-1, L1.delta(a), L2.delta(a), L3.delta(a));
        }
      }
    }
  }
