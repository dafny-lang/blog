...
If your run <code><span class="command">dafny run --no-verify euclidian.dfy</span><!--.command--></code>, you get the following output:
...
If your run <code><span class="command">dafny run --show-snippets euclidian.dfy</span><!--.command--></code>, you get the following output:
<!--The following is tested, and can also be overriden -->
<pre class="output">
...
If your run <code><span class="command">dafny run --show-snippets euclidian.dfy</span><!--.command--></code>, you finally get it working:
<!--The following is tested, and can also be overriden -->
<pre class="output">
...
If your now run <code><span class="command">dafny run --show-snippets euclidian.dfy</span><!--.command--></code>, you get the following result:
<!--The following is tested, and can also be overriden -->
<pre class="output">
...
If your run <code><span class="command">dafny run euclidian.dfy</span><!--.command--></code>, you get the following result:
<!--The following is tested, and can also be overriden -->
<pre class="output">
Dafny program verifier finished with 2 verified, 0 errors
47 = 3*13 + 8
...
Numerous test engines also display feedback in the gutter next to the methods themselves, or next to the method calls if they are tests (e.g. [wallabyjs](https://wallabyjs.com/) [xUnit](https://xunit.net/docs/getting-started/netfx/jetbrains-rider)...)}.
